...
```diff
- import "@openzeppelin-v5/contracts/utils/math/SafeMath.sol";
+ import "@openzeppelin-v5/contracts/utils/math/Math.sol";
...
```diff
-import "@openzeppelin-v5/contracts/utils/cryptography/draft-EIP712.sol";
...
```diff
-import "@openzeppelin-v5/contracts/token/ERC721/extensions/draft-ERC721Votes.sol";
+import "@openzeppelin-v5/contracts/token/ERC721/extensions/ERC721Votes.sol";
```
