...
import {IBeacon} from "@openzeppelin-v5/contracts/proxy/beacon/IBeacon.sol";
...
import { IProxyExposed } from "@openzeppelin-v5/contracts/mocks/UpgradeableBeaconMock.sol";
