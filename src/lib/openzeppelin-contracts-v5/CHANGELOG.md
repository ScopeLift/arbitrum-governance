...
```diff
- import "@openzeppelin-contracts-v5/utils/math/SafeMath.sol";
+ import "@openzeppelin-contracts-v5/utils/math/Math.sol";
...
```diff
-import "@openzeppelin-contracts-v5/utils/cryptography/draft-EIP712.sol";
+import "@openzeppelin-contracts-v5/utils/cryptography/EIP712.sol";
```
...
```diff
-import "@openzeppelin-contracts-v5/token/ERC721/extensions/draft-ERC721Votes.sol";
+import "@openzeppelin-contracts-v5/token/ERC721/extensions/ERC721Votes.sol";
```
